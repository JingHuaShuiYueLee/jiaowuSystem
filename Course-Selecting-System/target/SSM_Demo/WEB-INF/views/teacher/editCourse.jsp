...
<rapid:override name="content">
    ...
    <form class="layui-form" id="changeform" method="post" action="<%=basePath%>teacher/changeTeaPass" style="margin:80px 400px; width:450px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input value="${courseInfo.credit}" type="text" name="credit" id="credit" placeholder="请输入课程学分" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <c:forEach items="${insList}" var="ins">
                    <input type="checkbox" name="ins" value="${ins.insId}" title="${ins.insName}" <c:forEach items="${checkIns}" var="checkins"><c:if test="${ins.insId==checkins}"> checked</c:if></c:forEach> >
                </c:forEach>
            </div>
        </div>
    </form>
    ...
    <script>
        $(function () {
            $("#success").click(function () {
                ...
                var content=name+"|"+num+"|"+ins+"|"+credit;
                ...
                myform.method = "POST";
                myform.action = "<%=basePath%>teacher/updateCourseSuccess?page="+1 + "&courseid=" + <%=courseid%>;
                myform.submit();
