...
<rapid:override name="content">
    ...
    <form class="layui-form" style="margin:10px 15px 10px;">
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <input type="text" id="searchByCourseId" class="layui-input" style="float:right; width:200px;"
                       placeholder="请输入课程编号">
            </div>
        </div>
    </form>
                ...
                <td>
                    <c:choose>
                        ...
                        <c:when test="${course.isChoose==1}">
                            ...
                            <button class="layui-btn" onclick="delete_fun(${course.classId})" <c:if test="${course.isScored==1}"> disabled </c:if>>退课
                            </button>
                        </c:when>
                        <c:otherwise>
    ...
    <script>
        function search() {
            var courseid = document.getElementById("searchByCourseId").value;
