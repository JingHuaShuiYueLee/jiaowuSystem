...
<rapid:override name="content">
    ...
    <form class="layui-form" id="changeform" method="post" action="<%=basePath%>teacher/changeTeaPass" style="margin:80px 400px; width:450px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="credit" id="credit" placeholder="请输入课程学分" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script>
        $(function () {
            $("#success").click(function () {
                ...
                var content=name+"|"+num+"|"+ins+"|"+credit;//dom方式创建表单，该表单提交数据
                ...
                myform.submit();
                document.body.removeChild(myform);//用完就扔
            })
        })
    </script>
</rapid:override>
